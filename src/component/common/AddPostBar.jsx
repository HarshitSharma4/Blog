  ...
  return (
    <div className="my-5 mb-10">
      ...
      <Link to="/add-blog" className="fixed bottom-5 right-5 md:hidden z-20">
        <div className="rounded-[100%] shadow-[0_10px_20px_rgba(0,_0,_0,_0.7)] bg-primary flex items-center justify-center  hover:-translate-y-1 ">
          <FaPlus className="h-16 w-16 text-accent" />
        </div>
      </Link>
    </div>
  );
